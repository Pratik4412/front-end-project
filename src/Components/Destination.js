...
const Destination = () =>{
    return(
        <div className="destination">
            ...
            <p>Tours five you the opportunity to see a lot, within a time frame.</p>
            

            <DestinationData
            className="first-des"
            heading="Taal Volcano, Batangas"
            text="One of the most iconic views in tuzon, Mt. Taal boasts a 
            ...
            the way, and you'll see the peculiat environment found on 
            an active volcano, including volcanic rocks and steam 
            vents. The hikecan be dusty and hot, so plan or an early    
            morning trip, and then unwind with soe bulalo before 
            heading back home!"
            img1={Mountain1}
            img2={Mountain2}
            ...
            text="If You're looking for a hike thats a little more challenging 
                  but still good for a beginner mountaineer,check out Mt.
                  Daguldul in San Juan, Batangas. You'll start yout jike from 
